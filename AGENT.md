...
## Objective
Maintain `agent-benchmarks` as a reliable, useful, and test-first project aligned with its primary promise:
> Standardized evaluation suite for agents across eight business domains.
